...
# 등록할 슬래시 커맨드 파일 목록.
SOURCES=("tako.md" "tako-check.md" "tako-update.md" "tako-retype.md" "tako-list.md" "tako-guide.md")
...
say "6) 슬래시 커맨드:    /tako   /tako-check   /tako-update   /tako-retype   /tako-list   /tako-guide"
